document.querySelectorAll('footer-sigma').forEach(menu =>{
    const shadowRoot = menu.shadowRoot;

    const btnInicio = shadowRoot.querySelector('#inicioFooter');
    const btnListado = shadowRoot.querySelector('#listadoFooter');
    const btnRecientes = shadowRoot.querySelector('#recientesFooter');
